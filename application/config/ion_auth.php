 ...
 */
$config['site_title']           = "Forever";        // Site Title, example.com
$config['admin_email']          = "alex@alexose.com";  // Admin Email, admin@example.com
...
$config['email_config'] = 'email'; // Send Email using the builtin CI email class, if false it will return the code and the identity
